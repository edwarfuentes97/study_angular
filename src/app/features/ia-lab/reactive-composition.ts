...
@Component({
  selector: 'app-reactive-composition',
  imports: [RouterLink, RouterLinkActive],
  templateUrl: './reactive-composition.html',
  styleUrl: './reactive-composition.css'
})
export class ReactiveCompositionComponent implements OnDestroy {
  // combineLatest state
