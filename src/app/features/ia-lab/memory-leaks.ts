...
@Component({
  ...
  template: `
    <div class="lab-header">
      ...
      <nav class="lab-nav">
        <a routerLink="/lab/ia" routerLinkActive="active" [routerLinkActiveOptions]="{ exact: true }">Inicio</a>
        <a routerLink="/lab/ia/concepts" routerLinkActive="active">Conceptos</a>
        <a routerLink="/lab/ia/examples" routerLinkActive="active">Ejemplos</a>
        <a routerLink="/lab/ia/search" routerLinkActive="active">Búsqueda</a>
        <a routerLink="/lab/ia/combining" routerLinkActive="active">Combinación</a>
        <a routerLink="/lab/ia/lab" routerLinkActive="active">Lab</a>
      </nav>
    </div>
